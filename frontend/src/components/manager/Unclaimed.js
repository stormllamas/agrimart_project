              ...
              {orderLoading ? (
                ...
                <Fragment>
                  <div className="modal-content">
                    ...
                    <p className="fs-16 m-0 ml-2">Subtotal: <span className="fw-4 fs-16 ml-2">₱ {order.ordered_subtotal.toFixed(2)}</span></p>
                    <p className="fs-16 m-0 ml-2">Delivery: <span className="fw-4 fs-16 ml-2">₱ {order.shipping.toFixed(2)}</span></p>
                    <p className="fw-6 fs-22 m-0 ml-2">Total: <span className="fw-4 fs-18 ml-2">₱ {(order.ordered_subtotal+order.shipping).toFixed(2)}</span></p>
                  </div>
                </Fragment>
              )}
